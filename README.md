# capstone-project: Serverless MOVIE-WISHLIST

To implement this project, you need to implement a simple Movie-Wishlist application using AWS Lambda and Serverless framework.
...
The application should store MOVIE items in as wishlist, and each MOVIE item contains the following fields:

* `movieId` (string) - a unique id for an item
* `createdAt` (string) - date and time when an item was created
* `title` (string) - title of a MOVIE item (e.g. "Change a light bulb")
* `done` (boolean) - true if an movie was watched, false otherwise
* `attachmentUrl` (string) (optional) - a URL pointing to an image attached to a MOVIE item

You might also store an id of a user who created a MOIVE item.
